...
do
  ...
  Src_FL=$line
	...
	Prop_file_path=$Property_Path/job_$Src_FL_Nm.properties
        ...
        echo -e "\n"Property file name: $Prop_file_path"\n"
...
echo spark2-submit --queue ingestion --class "com.spark.ingest.SparkIngestApp" --deploy-mode client --master yarn /home/n46995a/JarFiles/sparksample_2.11-0.1_CSV.jar $Prop_file_path "&">>spark_submit_command.sh
