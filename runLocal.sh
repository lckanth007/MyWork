...
do
  ...
  Src_FL=$line
	...
	echo spark2-submit --class "com.spark.ingest.SparkIngestApp" --deploy-mode client --master local[*] /home/n46995a/JarFiles/sparksample_2.11-0.1.jar $Prop_file_path "&">>spark_submit_command.sh
